...
class Edit extends Component {
    ...
    componentDidMount() {
        axios.get(window.Laravel.baseUrl + '/api/article/' + this.props.match.params.id)
            .then(response => {
                            ...
                            <form onSubmit={this.handleCreateNewProject} encType="multipart/form-data">
                                <div className="box-body">
                                    <div className="form-group col-xs-6">
                                        ...
                                        <input type="text" className="form-control" id="title" name="title" defaultValue={this.state.title}

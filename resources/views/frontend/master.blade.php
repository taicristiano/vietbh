...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="frontend/css/js/html5shiv.js"></script>
    <script src="frontend/css/js/respond.min.js"></script>
    <![endif]-->
    <link rel="shortcut icon" href="css/frontend/images/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="css/frontend/images/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="css/frontend/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="css/frontend/images/ico/apple-touch-icon-72-precomposed.png">
